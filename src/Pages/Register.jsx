...
const Signup = () => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen pt-18 pb-16 bg-green-50">
            <div className="w-[88%] md:w-[40%] pb-3 rounded-[0.7rem] bg-white overflow-hidden shadow ">
                ...
                <div className="card-body">
                    ...
                    <p className="text-gray-500 text-center"> Already have an account?  <Link to="/login" className="text-green-700  font-medium hover:link " >  Login </Link>{" "} </p>
