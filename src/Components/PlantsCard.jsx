...
const PlantsCard = ({ plant }) => {
    ...
    return (
        <div className="w-full bg-white rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg border border-gray-100"  >

            <div className="w-full h-[25.1rem] md:h-[15.1rem] overflow-hidden"> 
                <img  src={image}  alt={plantName}  className="w-full h-full object-cover"/>
            </div>

            <div className="p-4 space-y-3">
                <div className='flex justify-start pb-2'>
                    <span className="px-3 py-1 text-xs font-medium text-gray-800 bg-gray-100 rounded-full"> {category }</span>
                </div>
