    ...
    return (
        <div className="pt-12 pb-16 bg-gray-100">
            <div className="mx-auto px-4">
                ...
                <motion.div className="grid grid-cols-1 md:grid-cols-4 gap-8"  variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: false, amount: 0.3 }} >
                    {experts.map((expert) => (
