        ...
        <div className="pt-12 pb-16 bg-gray-100">
            <div className="mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {   
                        experts.map(expert => (
                            <div key={expert.id} className="bg-white rounded-xl shadow-md p-6 text-center border border-gray-100 transform transition duration-300 hover:shadow-xl hover:-translate-y-2">
